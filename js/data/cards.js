...
}, 
{
	...
	ss1: {
		...
		turn: 7,
		proc: [ss_damage_all(3.0, [0]), ss_continue_damage(3.0, [0], 3)],
	},
	awakes: [
		Panel_boost([1,0,0,0,0,],1),
		Statusup(0,200),
	...
	ss2: {
		...
		turn: 9,
		proc: [ss_damage_all(4.0, [0]), ss_continue_damage(4.0, [0], 3)],
	},
	Lawake: [
		Statusup(0,600),
		Statusup(400,0),
...
　　　　　Awake_noeffect("心眼", 1),
	...
	ss1: {
		...
		turn: 7,
		proc: [ss_damage_all(2.0, [1]), ss_continue_damage(2.0, [1], 3)],
	},
	awakes: [
		Statusup(200,0),
		Statusup(0,200),
	...
	ss2: {
		...
		turn: 9,
		proc: [ss_damage_all(3.0, [1]), ss_continue_damage(3.0, [1], 3)],
	},
	Lawake: [
		Attr_statusup(0,200, [0,1,0,0,0,]),
	],
