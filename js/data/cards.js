...
　　　　　Awake_noeffect("心眼", 1),
	...
	as1: {
		...
		proc: ChainPanelsAttrAttack(5.0, 7.0, 7.0, [0,0,1,0,0], 4),
	},
	ss1: {
		desc: "<ブースト>5ターンの間、MAXHPを毎ターン15%消費し、攻撃力をアップ(1200%)。さらに極稀にクリティカル",
		turn: 10,
	...
	as2: {
		...
		proc: ChainPanelsAttrAttack(6.0, 8.0, 8.0, [0,0,1,0,0], 4),
	},
	ss2: {
		desc: "<ブースト>5ターンの間、MAXHPを毎ターン15%消費し、攻撃力をアップ(1500%)。さらに極稀にクリティカル",
		turn: 13,
...
　　　　　　　　Abstate_invalid("poison"),
	...
	ss2: {
		...
		turn: 5,
		proc: [panel_chainplus(ss_is_poison_own(5, 1))],
	},
	Lawake: [
		Statusup(0,500),
		Attr_statusup(0,100, [1,0,0,0,0,]),
	...
	ss1: {
		desc: "<多弾魔術>敵全体へ火属性の10回連続ダメージ(180%)",
		turn: 6,
	...
	ss2: {
		desc: "<多弾魔術>敵全体へ火属性の10回連続ダメージ(320%)",
		turn: 9,
