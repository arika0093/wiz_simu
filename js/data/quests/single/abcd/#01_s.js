      ...
      },
      {
         ...
         enemy: [
            ...
            },
            {
               ...
               move: {
                  on_move: [
                     m_enemy_once(s_enemy_noeffect("パネル変換([0,0,1,0,0])")/* Warning: シミュレータのほう実装してください・・ */),
            ...
            },
            {
               ...
               move: {
                  ...
                  on_move_angry: [
                     ...
                     s_enemy_delay_attack(2000, 3),
                     s_enemy_delay_attack(2000, 1),
                     s_enemy_delay_attack(2000, 1),
                     s_enemy_delay_attack(2000, 1),
                     s_enemy_delay_attack(2000, 1)
                  ],
         ...
         enemy: [
            {
               ...
               move: {
                  on_move: [
                     m_enemy_once(s_enemy_noeffect("パネル変換([1,0,0,0,0])")/* Warning: シミュレータのほう実装してください・・ */),
                     s_enemy_attack(2000, 1, 1, true)
                  ],
                  atrandom: false,
                  turn: 1,
