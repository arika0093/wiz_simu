{
	...
	ss1: {
		desc: "<多弾魔術>スキル反射を無視し、敵単体へ雷・光属性の5回連続ダメージ(250%)",
		turn: 5,
		proc: [ss_damage_s(2.5, [2,3], 5), ss_ignore_skillcounter()],
	},
	awakes: [
		Fastskill(2),
		Costdown(2),
	...
	ss2: {
		desc: "<多弾魔術>スキル反射を無視し、敵単体へ雷・光属性の5回連続ダメージ(450%)",
		turn: 7,
		proc: [ss_damage_s(4.5, [2,3], 5), ss_ignore_skillcounter()],
	},
	Lawake: [
