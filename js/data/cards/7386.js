{
	...
	ss1: {
		desc: "<時限大魔術>スキル反射を無視し、3ターン後に敵単体へ火属性のダメージ(1000%)",
		turn: 2,
		proc: [ss_damage_timebomb(10, [0], 1, 3), ss_ignore_skillcounter()],
	},
	awakes: [
	...
	as2: {
		desc: "<属性特効>雷属性の敵単体へ特効ダメージ、解答が早いほどさらにアップ(基本:450%, 3秒台:500%, 2秒台:550%, 1秒台:600%, 0秒台:650%)",
		proc: add_cond(ChainAttrAttack(4.5, 0, [0,0,1,0,0]), as_timedep(0.5)),
	},
	ss2: {
		desc: "<時限大魔術>スキル反射を無視し、3ターン後に敵単体へ火属性のダメージ(2000%)",
		turn: 3,
