{
	...
	ss1: {
		desc: "<連鎖解放大魔術>スキル反射を無視し、ターン終了時に敵全体へ雷属性のダメージ(100%)、すべてのチェインを消費して、消費した数に応じてさらにダメージアップ(上限値:30チェインで3300%)",
		turn: 8,
		proc: [ss_burst_attack(1.0, 33.0, 30, [2], 1), ss_ignore_skillcounter()],
	},
	awakes: [
	...
	ss2: {
		desc: "<連鎖解放大魔術>スキル反射を無視し、ターン終了時に敵全体へ雷属性のダメージ(100%)、すべてのチェインを消費して、消費した数に応じてさらにダメージアップ(上限値:30チェインで4200%)",
		turn: 11,
		proc: [ss_burst_attack(1.0, 42.0, 30, [2], 1), ss_ignore_skillcounter()],
	},
	Lawake: [
		Statusup(0,1000),
