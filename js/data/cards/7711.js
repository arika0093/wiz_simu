{
	...
	ss1: {
		desc: "<多弾魔術>スキル反射を無視し、MAXHPの50%を使い敵単体へ火・闇属性の5回連続ダメージ(450%)",
		turn: 5,
		proc: [ss_damage_s(4.5, [0,4], 5), ss_consume_own(0.5), ss_ignore_skillcounter()],
	},
	awakes: [
	...
	ss2: {
		desc: "<多弾魔術>スキル反射を無視し、MAXHPの50%を使い敵単体へ火・闇属性の5回連続ダメージ(750%)",
		turn: 8,
		proc: [ss_damage_s(7.5, [0,4], 5), ss_consume_own(0.5), ss_ignore_skillcounter()],
	},
	Lawake: [
		Statusup(0,700),
		Statusup(300,0),
