{
	...
	ss1: {
		desc: "<大魔術>スキル反射を無視し、敵全体へ水・光属性のダメージ(100%)、さらに味方全体のHPを回復する(25%)",
		turn: 4,
		proc: [ss_damage_all(1.0, [1,3]), ss_heal(0.25), ss_ignore_skillcounter()],
	},
	awakes: [
	...
	ss2: {
		desc: "<大魔術>スキル反射を無視し、敵全体へ水・光属性のダメージ(130%)、さらに味方全体のHPを回復する(25%)",
		turn: 6,
		proc: [ss_damage_all(1.3, [1,3]), ss_heal(0.25), ss_ignore_skillcounter()],
	},
	Lawake: [
